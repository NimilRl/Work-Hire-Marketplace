...
<html lang="en">
    ...
    <head>
        ...
        <title>Workflow | Domain Work Report</title>
            ...
            <div class="content container-fluid">
                ...
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="page-title">Domain Work Report</h3>
                            <ul class="breadcrumb">
                            ...
                            <div class="row filter-row">
                                <div class="col-sm-6 col-md-3">
                                        <div class="form-group">
                                            <?php $domainw = mysqli_query($db_connection, "SELECT * FROM dt_domain_master"); ?>

                                            <label>Select Domain</label>
                                            <select class="form-select" name="select_domain" style="width:300px; height:50px;">
                                            <option value="0">Select domain</option>
                                            <?php
                                            while ($row = mysqli_fetch_assoc($domainw)) {
...
<!--                            <ul role="tablist" class="nav nav-pills card-header-pills nav-justified">
                        ...
                        <?php
                        $result = mysqli_query($db_connection, "SELECT * FROM dt_domain_master");
//                        $count = mysqli_query($db_connection, "SELECT company_name FROM dt_employer");
                        ?>
...
//                                            $get_id;    
                                            ...
                                            while ($row = mysqli_fetch_assoc($result)) {
                                                ...
                                                $get_id= $row['domain_id'];
                                                $count = mysqli_query($db_connection, "SELECT sum(work_status='C') AS Completed, sum(work_status='P')AS Pending, sum(work_status='W')AS Working FROM dt_workpost WHERE domain_id = 10");
//                                              
//                                                echo "<tr>" . $count . "</tr>";
//                                                $countdata = $count->mysqli_fetch_assoc();
//                                                echo "<td>" . $d1 . "</td>";
//                                                echo "<td>" . $row['domain_name'] . "</td>";
//                                                echo "<td>" . $countdata['work_status'] . "</td>";
//                                                echo "<td>" . $countdata['work_status'] . "</td>";
//                                                echo "<td>" . $countdata['work_status'] . "</td>";
//                                                echo "<td>" . $countdata['work_status'] . "</td>";
                                                echo"<td>";
                                              //        echo"<div>";
//                                               echo"<a href='javascript:void(0);' class='btn btn-sm btn-secondary me-2' data-bs-toggle='modal' data-bs-target='#edit-category'><i class='far fa-edit'></i></a>";
//                                               echo "<a href='delete_data.php?domain_id=$d1' class='btn btn-sm btn-danger' data-bs-toggle='modal' data-bs-target='#delete_category'><i class='far fa-trash-alt'></i></a>";
...
//
//                                                $countryname = mysqli_query($db_connection, "SELECT dt_country_master.country_name,dt_user.user_name FROM dt_country_master INNER JOIN dt_user ON dt_country_master.country_id=".$c_name1);
