                        ...
                        <div class="col-xl-9 col-md-8">
                            ...
                            <nav class="user-tabs mb-4">
                                <ul class="nav nav-tabs nav-tabs-bottom nav-justified">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="freelancer-suggestion-projects.php">Suggestion</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link active" href="freelancer-suggestion-skill-projects.php">Suggestion By Skill</a>
                                    </li>
                                    <li class="nav-item">
                            ...
                            if (mysqli_num_rows($check_user_data) > 0) {
                                ...
                                $check_user_skill = mysqli_query($db_connection, "SELECT * FROM `dt_freelancer_skill` WHERE user_id = $id;");

                                if (mysqli_num_rows($check_user_skill) > 0) {
                                    ?>

                                    <div class="proposals-section">
                                        <h3 class="page-subtitle">If you want to add more skills please <a data-bs-toggle="modal" href="#file"> click here </a></h3>
                                        <?php
                                        ...
                                        try {
                                            ...
                                            $work = sortByFilter($row_profile['domain_id'], $_SESSION['login_F'], $row_profile['experience_year']);
                                    ...
                                    <div class="proposals-section">
                                        ...
                                        <div class="freelancer-proposals">
                                            <div class="project-proposals align-items-center freelancer">
                                                <h4 style="text-align: center;">⏳ You have to Add some skills to get recommendation on works <a data-bs-toggle="modal" href="#file"> click here </a>to add it ⏳</h4>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <p class="text-muted mb-0">Enter multiple skills that you have</p>
                                            </div>
                                        </div>
