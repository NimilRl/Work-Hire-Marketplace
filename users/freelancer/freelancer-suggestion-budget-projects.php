                ...
                <div class="col-xl-9 col-md-8">
                    ...
                    <nav class="user-tabs mb-4">
                        <ul class="nav nav-tabs nav-tabs-bottom nav-justified">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="freelancer-suggestion-budget-projects.php">Suggestion By Budget</a>
                            </li>
                        </ul>
                    </nav>
                    ...
                    <?php
                        ...
                        //sortByHourlyRate($user_id, $hourly_range )
                        $work = sortByHourlyRate($_SESSION['login_F'] , $row_profile['range_id']);
