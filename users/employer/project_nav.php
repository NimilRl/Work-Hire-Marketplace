<div class="settings-widget">
                                <div class="settings-header d-sm-flex flex-row flex-wrap text-center text-sm-start align-items-center">
                                    <a href="user-account-details.html"><img alt="no img " onerror="this.onerror=null; this.src='../../assets/img/usericon1white.png'" src="../files/user_imgs/<?php echo $user['user_profile_img']; ?> " class="avatar-lg rounded-circle"></a>
                                ...
                                <div class="settings-menu">
                                    <ul>
                                        ...
                                        <li class="nav-item">
                                            <a href="manage-workposts.php" class="nav-link active">
